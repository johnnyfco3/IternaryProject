...
function App() {
  ...
  const [posts, setPosts] = useState([
    { id: 1, name: "World Trade Center", img: "https://images.unsplash.com/photo-1582436416930-f533b50a7cd8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=436&q=80", caption: "One World NYC", adventureID: 1 },
    { id: 2, name: "Little Island", img: "https://images.unsplash.com/photo-1622491088758-364f7e4908fb?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=464&q=80", caption: "Such a beautiful park!", adventureID: 1 },
    { id: 3, name: "The Vessel", img: "https://images.unsplash.com/photo-1559613527-817fdce54129?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=435&q=80", caption: "Spending a Sunday Afternoon at the vessel.", adventureID: 1 },
    { id: 4, name: "Time Square", img: "https://images.unsplash.com/photo-1595901688281-9cef114adb0b?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", caption: "Too many people!", adventureID: 1 },
    { id: 5, name: "Central Park", img: "https://images.unsplash.com/photo-1558385953-d50e6afd94c2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80", caption: "Finally a space to breathe", adventureID: 1 },
    { id: 6, name: "Rialto Bridge", img: "https://images.unsplash.com/photo-1562967967-edb2915098dc?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8cmlhbHRvJTIwYnJpZGdlfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60", caption: "Venice couldn't be more beautiful!", adventureID: 3 },
    { id: 7, name: "Doge's Palace", img: "https://images.unsplash.com/photo-1567012198973-b8843811d618?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80", caption: "Beautiful Museum", adventureID: 3 },
    { id: 8, name: "St. Marks Square", img: "https://images.unsplash.com/photo-1628106913234-9cdfddbf6b81?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=388&q=80", caption: "Great Location for photos!", adventureID: 3 },
  ])
    ...
    <div className="App">
      <Router>
        <Routes>
          ...
          <Route path="/overview/:adventureID/:id" element={<Overview adventures={adventures} posts={posts} setPosts={setPosts} comments={comments} setComments={setComments} users={users}/>}/>
          <Route path="/history/:id" element={<History users={users} adventures={adventures}/>}/>
          <Route path="/history/upcoming/:id" element={<Upcoming date={date} adventures={adventures} setAdventures={setAdventures} users={users}/>}/>
          <Route path="/history/current/:id" element={<Current date={date} adventures={adventures} setAdventures={setAdventures} users={users}/>}/>
          <Route path="/history/past/:id" element={<Past date={date} adventures={adventures} setAdventures={setAdventures} users={users}/>}/>
